...
typedef enum { SIZE_TINY = 2, SIZE_SMALL = 4, SIZE_AVERAGE = 6, SIZE_LARGE = 8, SIZE_HUGE = 10 } size_type;
...
typedef enum { SEX_NEUTRAL, SEX_MALE, SEX_FEMALE, SEX_HERMAPHRODITE } sex_t;

typedef enum { COND_HUNGER, COND_THIRST, COND_DRUNK, COND_SANITY, MAX_COND } condition_t;
...
typedef enum { DEF_NORMAL, DEF_INCLUDE, DEF_EXCLUDE, DEF_READONLY } forum_t;

typedef enum { STAT_STR, STAT_INT, STAT_WIS, STAT_DEX, STAT_CON, STAT_LUCK, MAX_STAT, MAX_STAT_VALUE = 500 } stat_t;
