...
const char *stristr(const char *String, const char *Pattern) {
  ...
  for (start = String; *start != 0; start++) {
    ...
    for (; ((*start != 0) && (toupper((int)*start) != toupper((int)*Pattern))); start++)
      ;
...
const char *str_replace(const char *orig, const char *old, const char *pnew) {
  ...
  if ((ptr = strstr(orig, old)) == NULL || (a = ptr - orig) + (len = strlen(pnew)) >= (OUT_SIZ - 4)) {
    return orig;
  }
  ++i, i %= 7;
  buf = outbuf[i];
...
const char *str_replace_all(const char *orig, const char *old, const char *newstr) {
  const char *ptr = NULL;
  size_t len = 0;
...
const char *str_ireplace(const char *orig, const char *old, const char *pnew) {
  ...
  if ((ptr = stristr(orig, old)) == NULL || (a = ptr - orig) + (len = strlen(pnew)) >= (OUT_SIZ - 4)) {
    return orig;
  }
  ++i, i %= 7;
  buf = outbuf[i];
...
const char *str_ireplace_all(const char *orig, const char *old, const char *newstr) {
  const char *ptr = NULL;
  size_t len = 0;
  ...
  while ((ptr = stristr(orig, old)) && (ptr - orig) + len < (OUT_SIZ - 4)) {
...
const char *one_argument(const char *argument, char *arg) { return first_arg(argument, arg, false); }
...
const char *align_string(align_t align, int width, const char *color, const char *fill, const char *str) {
...
const char *valign_string(align_t align, int width, const char *color, const char *fill, const char *fmt,
                          va_list args) {
  char buf[OUT_SIZ] = {0};
...
bool nullstr(const char *str) { return (str == 0 || *str == 0); }
 ...
 */
long number_argument(const char *argument, char *arg) { return x_argument('.', argument, arg); }

long multi_argument(const char *argument, char *arg) { return x_argument('*', argument, arg); }
