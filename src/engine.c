...
const char *weekdays[] = {"Muday", "Aberday", "Dikuday", "Circleday", "Mercday", "Smaugday", "Romday"};

const char *months[] = {"Dragon",   "Sword", "Dagger", "Centaur", "Sea",     "Shield",
                        "Mountain", "Sun",   "Moon",   "Wolf",    "Griffon", "Horse"};

const char *seasons[] = {"Darkness", "Life", "Light", "Leaves"};

const float exp_table[EXP_TABLE_SIZ] = {5.9f, 5.9f, 5.9f, 5.9f, 6.2f, 6.2f, 6.2f, 6.2f, 6.5f, 6.5f, 6.5f,
                                        6.5f, 6.8f, 6.8f, 6.8f, 6.8f, 7.1f, 7.1f, 7.1f, 7.1f, 7.2f};

const Lookup stat_table[] = {{"strength", STAT_STR},
...
const Lookup engine_flags[] = {{0, 0}};

void initialize_default_engine() { engine_info.name = str_dup("Muddled"); }
...
field_map *engine_field_map(Engine *info) {
  ...
  field_map engine_values[] = {{"engineId", &info->id, SQL_INT},
