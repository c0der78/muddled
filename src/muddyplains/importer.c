	...
	for (;;) {
		...
		case 2:
		    set_bit(set_bit
			    (set_bit
			     (pexit->flags,
			      EXIT_ISDOOR), EXIT_CLOSED), EXIT_LOCKED);
		    break;
		case 3:
		    //pexit->flags = EX_ISDOOR | EX_CLOSED | EX_LOCKED | EX_NOPASS;
		    break;
		    set_bit(set_bit
			    (set_bit
			     (pexit->flags,
		    ...
		    break;
		case 4:
		    //pexit->flags = EX_ISDOOR | EX_CLOSED | EX_LOCKED | EX_PICKPROOF;
		    break;
		    set_bit(set_bit
			    (set_bit
			     (pexit->flags,
		    ...
		    break;
		case 5:
		    //pexit->flags = EX_ISDOOR | EX_CLOSED | EX_LOCKED | EX_PICKPROOF | EX_NOPASS;
		    break;
		    set_bit(set_bit
			    (set_bit
			     (pexit->flags,
...
{
    char buf[OUT_SIZ * 4];	/* extra 2 bytes on the end
				 * for \0 and 1b slack */
    long i = 0;
    register char c;
    bool sFull = false;
