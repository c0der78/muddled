...
/*!
 * @typedef Account
 * @abstract Represents a user account.  An account may have multiple game characters.
 * @author Ryan Jennings <c0der78@gmail.com>
 * @field login account id used to login
 * @field email email address for account
 * @field password encrypted password for account
 * @field players a list of players linked to the account
 * @field timezone the timezone of the account user
 * @field autologinId id of the player to autologin with
 * @field flags flags that modify account behaviour
 * @field forum the current forum the account is reading. will never be null.
 * @field inProgress the current note in progress. Can be null.
 * @field forumData data cached from all forums
 ...
 * @abstract a player associated with an account
 * @field charId the character id
...
/*!
 * @struct AccountForum
 * @abstract a forum associated with an account
 * @field lastNote the last note read in the forum
...
/*!
 * @enum Account Flags
 * @abstract flags for controlling account behaviour
...
/*!
 * @const account_flags
 * @abstract the table used for account flag / string conversion
 */
 ...
 * @param account the allocated account to load into
...
/*!
 * @param account the account to get value from
 * @return the last read note for the current forum
 */
time_t account_forum_last_note(Account *);

/*!
 * @param account the account to get value from
 * @return true if account is subscribed to current forum
 */
bool account_forum_is_subscribed(Account *);

/*!
 * sets the last note timestamp for the current forum
 * @param account the account to set value for
 * @param time the created time of the last note
 */
